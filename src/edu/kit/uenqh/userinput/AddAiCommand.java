...
import static edu.kit.uenqh.model.Constants.AMOUNT_OF_ARGUMENTS_PER_AI;
import static edu.kit.uenqh.model.Constants.MINIMUM_NUMBER_OF_AIS_PER_GAME;
...
public class AddAiCommand implements Command {
     ...
     *
     * @param model            The GameSystem edu.kit.uenqh.model.
