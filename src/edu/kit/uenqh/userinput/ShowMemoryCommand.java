...
import edu.kit.uenqh.model.GameStorage;
import edu.kit.uenqh.model.GameStorageCell;
import edu.kit.uenqh.model.GameSystem;
import edu.kit.uenqh.utility.CircularArrayList;
...
import static edu.kit.uenqh.model.Constants.CURRENT_AI_SYMBOL_INDEX;
...
import static edu.kit.uenqh.model.Constants.UNCHANGED_FIELD_SYMBOL_INDEX;
...
public class ShowMemoryCommand implements Command {
     ...
     * If an argument is provided, a detailed edu.kit.uenqh.view starting from the specified position is displayed.
     * </p>
     *
