...
import static edu.kit.uenqh.model.Constants.ADD_AI_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.END_GAME_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.ERROR_PREFIX;
import static edu.kit.uenqh.model.Constants.HELP_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.NEXT_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.NEXT_LINE;
import static edu.kit.uenqh.model.Constants.QUIT_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.REMOVE_AI_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.SET_INIT_MODE_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.SHOW_AI_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.SHOW_MEMORY_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.START_GAME_COMMAND_NAME;
import static edu.kit.uenqh.model.Constants.WRONG_ARGUMENTS_COUNT_FORMAT;
